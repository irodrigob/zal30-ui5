sap.ui.define([
	...
	function (Control, Fragment, Filter) {
		...
		var oSelectTransportOrder = Control.extend("com.ivancio.zal30-ui5.component.viewData.selectTransportOrder.SelectTransportOrder", {
			...
			openDialog: function (oController) {
				...
				if (!this._oDialog) {
					Fragment.load({
						...
						name: "com.ivancio.zal30-ui5.component.viewData.selectTransportOrder.SelectTransportOrder",
						controller: that
